...
/// The RNG, initialized exactly once on first use.
...
mod tests {
    ...
    fn test_deterministic() {
        ...
        fill_inner(&mut buf).unwrap();
        let bytes: &[u8] = unsafe { buf.assume_init_mut() };
        assert_eq!(
            [
                0x1b, 0x8c, 0x20, 0xcd, 0xe2, 0xdb, 0xb4, 0x3c, 0xd3, 0xc7, 0x09, 0xb2, 0x90, 0xac,
